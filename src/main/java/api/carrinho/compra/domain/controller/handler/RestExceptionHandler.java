package api.carrinho.compra.domain.controller.handler;
...
import api.carrinho.compra.domain.controller.handler.builder.ErrorDetails;
import api.carrinho.compra.domain.controller.handler.builder.ValidationErrorDetails;
import api.carrinho.compra.domain.service.exceptions.ResourceDuplicateException;
